//! YOLOv8 Pose model implementation using Candle
//!
...
impl YoloV8Pose {
    ...
    /// * `m` - Model size multipliers
    /// * `num_classes` - Number of object classes (1 for pose)
    /// * `kpt` - Keypoint configuration (num_keypoints, values_per_keypoint)
    pub fn load(
        vb: VarBuilder,
        m: Multiples,
        num_classes: usize,
