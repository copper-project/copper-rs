        ...
        mkDevShell =
          ...
          let
            ...
            cudaStatus =
              if effectiveCuda then
                " with CUDA support"
              else if withCuda && isDarwin then
          ...
          pkgs.mkShell {
            ...
            shellHook = ''
              ...
              export FEATURES_FLAG="--features mock,cu-sensor-payloads/image,kornia,python,gst,faer,nalgebra,glam,debug_pane,bincode${cudaFeatureFlag}"
