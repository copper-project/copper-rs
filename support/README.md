...
- `cd catalog && just` — generate the Copper component catalog JSON, Markdown, and filterable HTML.
- `just mkpartition /dev/sdX` — partition/format an SD card for Cu29 logging (destroys data).
