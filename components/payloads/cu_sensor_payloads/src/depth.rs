...
///
/// Every sample is a [`Length`]. Non-finite values are preserved and may be used
/// by producers to mark invalid measurements.
    ...
    CuHandle<A>: Serialize,
{
        ...
        S: Serializer,
    {
        ...
        let mut state = serializer.serialize_struct("CuDepthMap", 2)?;
