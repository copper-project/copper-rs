...
These files are generated from local system JetBrains Mono Nerd Font Mono faces and patched with the
missing DAG icon glyphs from local Iosevka Fixed SS10 faces so the Bevy monitor does not depend on
