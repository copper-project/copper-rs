                        ...
                        match header.entry_type {
                            ...
                            UnifiedLogType::CopperList => {
                                ...
                                for entry in iter {
                                    ...
                                    let last_msg =
                                        *entry.cumsgs().last().expect("Empty copperlist");
                            ...
                            UnifiedLogType::LastEntry => {
                                ...
                                let cl_rate = 1_000_000_000f64 / (cl_time.as_nanos() as f64);
                                let kf_rate = 1_000_000_000f64 / (kf_time.as_nanos() as f64);
                                println!();
