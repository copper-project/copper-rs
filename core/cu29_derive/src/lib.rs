        ...
        let application_impl = quote! {
            #app_impl_decl {
                ...
                #new {
                    ...
                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: config file {}", config_filename);
                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: loading config");
                    #config_load_stmt
                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: config loaded");
                    if let Some(runtime) = &config.runtime {
                        ...
                        #[cfg(target_os = "none")]
                        defmt::info!("CuApp new: rate_target_hz=none");
                    }
                    ...
                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: creating copperlist stream");
                    ...
                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: copperlist stream ready");

                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: creating keyframes stream");
                    ...
                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: keyframes stream ready");

                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: building runtime");
                    let copper_runtime = CuRuntime::<#mission_mod::#tasks_type, #mission_mod::CuBridges, #mission_mod::CuStampedDataSet, #monitor_type, #DEFAULT_CLNB>::new(
                        ...
                        keyframes_stream)?;
                    #[cfg(target_os = "none")]
                    defmt::info!("CuApp new: runtime built");
